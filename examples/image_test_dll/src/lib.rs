...
impl ImageTestHaCK {
    ...
    fn update_player(&mut self, ui: &StableUiBackend_TO<'_, abi_stable::sabi_types::RRef<'_, ()>>) {
        ...
        let dt = 0.016;
        self.player.update(ui, &self.level_data, dt, self.enabled);
...
impl StableHaCK for ImageTestHaCK {
    ...
    fn render_draw(
        ...
        if self.show_collision_debug {
            ...
            draw_bg.add_rect([bx1, by1], [bx2, by2], [1.0, 0.0, 0.0, 1.0], false);
                ...
                if let Some(images) = &self.image_list {
                    ...
                    if !frames.is_empty() {
                        ...
                        if self.preview.show_collision_box {
                            // Draw dummy box relative to preview center
                            // ...
                        }
                    }
                }
